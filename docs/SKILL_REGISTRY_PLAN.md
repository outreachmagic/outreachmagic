...
**Goal:** Listed on HermesHub and federated registries. Follow submission order from launch playbook.

| Task | Status |
|------|--------|
| Day 0: Public repo with SKILL.md, SECURITY.md, LICENSE, README | **Done** |
...
Submit skill directory: `skills/outreachmagic/` (or mirror into `amanning3390/hermeshub/skills/outreachmagic/` per their contribution flow).
...
- **Dedicated repo:** Launch playbook mentions `outreachmagic/outreachmagic-skill` as a separate public repo; current repo is `outreachmagic/hermes-agent`. Decide whether to split or submit from this repo.

---

## Priority order for next work

1. **Phase 5** — Registry submissions (after Reviewed Domains + first release tag)
2. **Phase 3** — Remaining hardening items
3. **Phase 0 manual** — HermesHub domains issue, GitHub topics (`gh auth login`)
