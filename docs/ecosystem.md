...
Source code and companion mirrors live under `outreachmagic/`. Implementation repos live under `~/Developer/` (or adjust paths in `outreach-magic.code-workspace`).
...
| [api.outreachmagic.io](https://api.outreachmagic.io) | `wbhk-worker` | Edge worker + database | **Relay** — webhooks, push/pull, usage limits |

## Agent install (what users download)

| Repo | Public? | Purpose |
|------|---------|---------|
| [outreachmagic/outreachmagic](https://github.com/outreachmagic/outreachmagic) (this repo) | Public monorepo | Skills source, tests, CI, `install.sh`, `pipeline.py update` target |
| [outreachmagic/lead-enrich](https://github.com/outreachmagic/lead-enrich) | Public (read-only mirror) | Companion skill |
| [outreachmagic/email-finder](https://github.com/outreachmagic/email-finder) | Public (read-only mirror) | Companion skill |
| [outreachmagic/brand](https://github.com/outreachmagic/brand) | Public (read-only mirror) | Logo assets |
...
| Skill CLI, SQLite pipeline, review export/sync | `outreachmagic/outreachmagic` | `skills/outreachmagic/scripts/` |
...
| Free/Pro/Scale event caps (enforced) | `wbhk-billing` | `src/plans.ts` |
...
```bash
cursor outreachmagic/outreachmagic/outreach-magic.code-workspace
```
