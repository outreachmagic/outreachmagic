#!/usr/bin/env bash
# Install outreachmagic (+ optional companions) under ~/.claude/skills/.
set -euo pipefail

SKILLS_DIR="$HOME/.claude/skills"
OM_REPO="https://github.com/outreachmagic/claude-code-outreachmagic.git"
...
install_outreachmagic() {
  local tmp
  tmp="$(mktemp -d -t om-claude-XXXXXX)"
