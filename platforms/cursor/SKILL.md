...
python3 ~/.cursor/skills/outreachmagic/scripts/pipeline.py lead-table --workspace popcam --since today --json
```
...
```bash
python3 ~/.cursor/skills/outreachmagic/scripts/pipeline.py export --workspace popcam --tag nace --format csv
python3 ~/.cursor/skills/outreachmagic/scripts/pipeline.py export --workspace popcam --since today --format json
```
