...
name: lead-enrich
description: >
  Research anyone by name and company. Pulls back their LinkedIn, job title,
  bio, company domain, and website. Works standalone with a Serper API key, no heavy setup.
  With Outreach Magic, it checks your pipeline so you never pay twice for
  the same lead data.
version: 1.1.0
