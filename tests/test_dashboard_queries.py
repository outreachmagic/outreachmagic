...
def test_campaign_daily_matrix():
    ...
    # bounces are no longer a daily-matrix column (they live on Deliverability);
    # ensure the key is gone so the campaigns table/chart don't reference it.
    assert "bounces" not in day
